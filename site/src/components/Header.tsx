    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          {/* Logo */}
          <Link href="/" id="site-logo" className="block">
            <Image
          ...
          >
            <span
              className={`w-6 h-[1.5px] bg-soft-white transition-all duration-300 ${mobileOpen ? "rotate-45 translate-y-[4.5px]" : ""
                }`}
            />
            <span
              className={`w-6 h-[1.5px] bg-soft-white transition-all duration-300 ${mobileOpen ? "opacity-0 scale-0" : ""
                }`}
            />
            <span
              className={`w-6 h-[1.5px] bg-soft-white transition-all duration-300 ${mobileOpen ? "-rotate-45 -translate-y-[4.5px]" : ""
